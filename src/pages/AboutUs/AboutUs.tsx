...
const AboutUs: FC = () => {
	...
	const teamData = [
		...
		},
		{
			...
			descr: [
				t('aboutUs.team.person4.text1'),
				t('aboutUs.team.person4.text2'),
			],
		},
		{
			img: Alex,
			...
			descr: [
				t('aboutUs.team.person5.text1'),
				t('aboutUs.team.person5.text2'),
			],
		},
	]
			 ...
			 <section className={styles.section_2}>
				 ...
				 <div className={styles.list__wrapper}>
					 <div className={styles.list__col}>
						 <p className={styles.list__title}>{t('aboutUs.beliefs.values.title')}</p>
					 ...
					 <div className={styles.list__col}>
						 <p className={styles.list__title}>{t('aboutUs.beliefs.services.title')}</p>
						 <ul className={styles.list__items}>
							 <li className={styles.list__item}>
