...
export const Sorting: FC<ISorting> = () => {
	...
	return (
		 <div className={styles.wrapper}>
			 ...
			 <div onClick={handleClose} className={`${styles.container} ${isVisible ? styles.active : ''}`}>
				 <div onClick={(e) => e.stopPropagation()} className={styles.content}>
					 <div className={styles.content__title}>
						 <span>{t('mobileFilters.sort.modal.title')}</span>
						 <img onClick={handleClose} className={styles.img} src={closeImage} alt="close-image"/>
					 </div>
					 <div className={styles.content__items}>
						 {sorting?.map((item) => (
								...
								>
									<div className={`${styles.square} ${item.sort && styles.selected}`}>
