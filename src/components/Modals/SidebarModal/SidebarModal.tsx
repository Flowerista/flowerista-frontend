...
interface SidebarModalProps extends DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement> {} 

export const SidebarModal: FC<SidebarModalProps> = ({ className, ...props}) => {
