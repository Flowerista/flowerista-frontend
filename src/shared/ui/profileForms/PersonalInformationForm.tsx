...
import { PersonalInformationSchema } from '../../lib/validations';
import { Form, InputsWrapper, NameInput, SurnameInput } from '../appForm';
import { Title } from '../Title/Title.tsx';

import styles from './styles.module.scss';
import { useAppSelector } from '../../../store/store.ts';
import { upFirstChar } from '../../lib/helpers';
import { useTranslation } from 'react-i18next';
import { useChangePersonalInformation } from '../../../services/UserService/changePersonalInfo/changePersonalInfo.ts';
